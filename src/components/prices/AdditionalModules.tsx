...
export default function AdditionalModules() {
  ...
  // Header and description translate, but modules stay in English
  const t = translations[language] || translations.en;
  const tModules = translations.en; // Always English for module content

  const modules = [
    {
      index: 0,
      title: tModules.sportMode,
      description: tModules.sportModeDesc,
      price: '12,90 €',
      priceSuffix: tModules.perMonth,
      icon: (
    ...
    },
    {
      ...
      description: tModules.eventsModeDesc,
      price: '7,00 €',
      priceSuffix: tModules.perMonth,
      icon: (
    ...
    },
    {
      ...
      description: tModules.salesModeDesc,
      price: '3,00 €',
      priceSuffix: `${tModules.perService} ${tModules.perMonth}`,
      icon: (
    ...
    },
    {
      ...
      description: tModules.reservationsModeDesc,
      price: tModules.byAgreement,
      priceSuffix: '',
      icon: (
    ...
    },
    {
      ...
      description: tModules.placesKulturaModeDesc,
      price: '9,90 €',
      priceSuffix: tModules.perMonth,
      icon: (
    ...
    },
    {
      ...
      description: tModules.receptionCareDesc,
      price: '4,00 €',
      priceSuffix: tModules.perMonth,
      icon: (
    ...
    },
    {
      ...
      description: tModules.additionalLanguageDesc,
      price: '2,50 €',
      priceSuffix: `${tModules.perLanguage} ${tModules.perMonth}`,
      icon: (
    ...
    },
    {
      ...
      description: tModules.transportModeDesc,
      price: '3,00 €',
      priceSuffix: tModules.perMonth,
      icon: (
    ...
    },
    {
      ...
      description: tModules.ecoLabelDesc,
      price: '3,00 €',
      priceSuffix: tModules.perMonth,
      icon: (
    ...
    },
    {
      ...
      description: tModules.weatherModeDesc,
      price: '1,90 €',
      priceSuffix: tModules.perMonth,
      icon: (
    ...
    },
    {
      ...
      description: tModules.ratingModeDesc,
      price: '0,90 €',
      priceSuffix: tModules.perMonth,
      icon: (
    ...
    },
    {
      ...
      description: tModules.surveysFormsDesc,
      price: '3,00 €',
      priceSuffix: tModules.perMonth,
      icon: (
