                ...
                <div className="mt-8 pt-6 border-t border-white/10 opacity-0 animate-fade-in-up" style={{ animationDelay: '2.0s', animationFillMode: 'forwards' }}>
                  <div className="bg-gradient-to-br from-gray-900/30 to-slate-900/30 backdrop-blur-xl rounded-2xl border border-white/10 p-6">
                    ...
                    <div className="flex justify-center space-x-4">
                      <a href="#" className="w-12 h-12 rounded-xl bg-gradient-to-r from-blue-600 to-blue-700 flex items-center justify-center text-white hover:scale-110 hover:rotate-3 transition-all duration-300 shadow-lg group">
                      ...
                      <a href="#" className="w-12 h-12 rounded-xl bg-gradient-to-r from-purple-600 to-pink-600 flex items-center justify-center text-white hover:scale-110 hover:rotate-3 transition-all duration-300 shadow-lg group">
                        <svg className="w-6 h-6 group-hover:scale-110 transition-transform duration-300" fill="currentColor" viewBox="0 0 24 24">
                      ...
                      <a href="#" className="w-12 h-12 rounded-xl bg-gradient-to-r from-blue-400 to-blue-600 flex items-center justify-center text-white hover:scale-110 hover:rotate-3 transition-all duration-300 shadow-lg group">
                        <svg className="w-6 h-6 group-hover:scale-110 transition-transform duration-300" fill="currentColor" viewBox="0 0 24 24">
